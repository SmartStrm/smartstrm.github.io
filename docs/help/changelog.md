...
## v0.4.x
**核心特性**：增强任务管理，增强安全性与播放体验，新增夸克网盘TV驱动，重构影视识别功能，插件系统全面升级，存储浏览视图优化。
...
## v0.3.x
**核心特性**：新增飞牛影视刷新插件，支持IPv6双栈，优化302代理性能，增强天翼云盘驱动，本地文件系统支持实时监听。
...
## v0.2.x
**核心特性**：新增123云盘开放平台支持，本地文件系统支持实时监听文件变更，插件系统支持任务级别配置，日志自动清理功能。
...
## v0.1.x
**核心特性**：新增插件系统，支持Plex Web的STRM播放和302重定向，增强STRM生成错误处理，非法文件名修正和STRM内容替换插件。**
...
## v0.0.x
**核心特性**：首次发布，支持多驱动（OpenList/AList、WebDAV、本地文件、夸克网盘、115、天翼云盘），STRM生成与同步删除，Webhook支持，302直链播放，CloudDrive2实时触发任务。
